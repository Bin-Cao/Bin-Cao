...
In recent years, I developed a series of machine-learning algorithms for **crystal structure determination** ([XQueryer](https://github.com/Bin-Cao/XQueryer)), **crystal property prediction** ([PRDNet](https://github.com/Bin-Cao/PRDNet)), and **novel crystal discovery** ([SimXRD](https://github.com/Bin-Cao/SimXRD)). My first-author papers have appeared in materials science journals (e.g., National Science Review and Science Bulletin) and AI conferences such as ICLR.
